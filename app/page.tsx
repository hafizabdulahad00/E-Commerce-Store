    ...
    <section>
      ...
      <div className="w-full h-[800px] flex items-center justify-center sm:h-full sm:py-[50px] md:h-full md:py-[40px]">
        <div className="w-[1183px] h-[685px] flex flex-col items-center gap-[50px] sm:h-full md:h-full md:gap-[30px] sm:w-full">
          ...
          {/* Image-box */}
          <div className="w-[1145px] h-[550px] flex justify-center items-center gap-5 md:w-full sm:flex-col sm:w-full sm:h-full md:h-full">
      ...
      <div className="w-full h-[670px] bg-[#F9F1E7] flex justify-center items-center gap-[20px] md:flex-col md:h-full md:py-[50px] md:gap-[30px] md:px-3">
        {/* text */}
        ...
        <button className="text-[16px] leading-6 text-[#FFFFFF] Poppins font-semibold w-[176px] h-12 bg-[#B88E2F] ml-[300px] md:m-0 transition-all ease-in duration-300 hover:text-[#B88E2F] hover:bg-[#FFFFFF]">Explore More</button>
        </div>
      ...
      {/* Slider-animation*/}
      <div className="w-full h-full flex flex-col justify-center items-center gap-20 py-5 md:gap-0">
        {/* text */}
        ...
        {/* First Grid */}
        <div className="grid grid-cols-2 grid-rows-2 gap-x-8 gap-y-4 w-[30%] h-auto p-4 ml-[-150px] md:w-full md:m-0 md:gap-x-4 md:gap-y-6 md:p-2 sm:grid-cols-1 sm:gap-y-0 md:h-full md:justify-center md:items-center">
  {/* Box 1 */}
  <div className="h-[382px] w-[274px] bg-[url('/Animated1.png')] flex items-center justify-center mt-[-70px] md:mt-5 md:h-[200px] md:w-full sm:h-[200px] sm:mt-0 md:bg-no-repeat bg-cover">
  </div>

  {/*  Box 2  */}
  <div className="h-[312px] w-[451px] bg-[url('/Animated2.png')] flex items-center justify-center md:h-[200px] md:w-full sm:h-[200px] bg-cover">
  </div>

  {/* Box 3  */}
  <div className="h-[323px] w-[381px] bg-[url('/Animated3.png')] flex items-center justify-center mt-[-8px] md:h-[200px] md:w-full sm:h-[200px] md:bg-no-repeat bg-cover">
  </div>

  {/*  Box 4  */}
  <div className="h-[242px] w-[344px] bg-[url('/Animated4.png')] flex items-center justify-center col-start-2 ml-[108px] mt-[-8px] md:ml-0 md:h-[200px] md:w-full sm:h-[200px] md:bg-no-repeat bg-cover">
  </div>
        </div>
        {/* Second-box */}
        ...
        {/* Third-Grid */}
        <div className="grid grid-cols-2 grid-rows-2 gap-x-16 gap-y-2 w-[30%] h-auto p-4 mt-5 md:w-full md:m-0 md:gap-x-4 md:gap-y-4 md:p-2 sm:grid-cols-1 sm:gap-y-6 md:h-full">
  {/* Box 1 */}
  <div className="h-[348px] w-[290px] bg-[url('/Animated6.png')] flex items-center justify-center mt-[85px]  md:mt-5 md:h-[200px] md:w-full sm:h-[200px] sm:mt-0 bg-no-repeat bg-cover">
  </div>

  {/*  Box 2  */}
  <div className="h-[433px] w-[425px] bg-[url('/Animated7.png')] flex items-center justify-center md:h-[200px] md:w-full sm:h-[200px] bg-no-repeat bg-cover">
  </div>

  {/* Box 3  */}
  <div className="h-[242px] w-[178px] bg-[url('/Animated8.png')] flex items-center justify-center md:h-[200px] md:w-full sm:h-[200px] bg-no-repeat bg-cover">
  </div>

  {/*  Box 4  */}
  <div className="h-[196px] w-[258px] bg-[url('/Animated9.png')] flex items-center justify-center md:ml-0 md:h-[200px] md:w-full sm:h-[200px] bg-no-repeat bg-cover">
  </div>
        </div>
        </div>
      </div>
