...
const cartPage = () => {
  return (
    ...
    <div className='w-full h-[525px] flex justify-center items-center md:h-full'>
        <div className='w-[1240px] h-[390px] flex gap-[30px] md:flex-col md:h-full md:gap-[60px] md:py-5'>
            <div className='w-[817px] h-[215px] md:w-full'>
                {/* First-box */}
                <div className='h-[55px] flex justify-around items-center gap-[30px] bg-[#F9F1E7]'>
                <h4 className='text-[16px] text-[#000000] Poppins font-normal'>Product</h4>
                <h4 className='text-[16px] text-[#000000] Poppins font-normal'>Price</h4>
                <h4 className='text-[16px] text-[#000000] Poppins font-normal'>Quantity</h4>
                <h4 className='text-[16px] text-[#000000] Poppins font-normal'>Subtotal</h4>
                </div>
                {/* second-box */}
                <div className='h-full flex justify-between items-center sm:gap-[20px] sm:px-5 md:px-3'>
                    <div className='w-[108px] h-[105px] bg-[#FFF3E3] rounded-[10px] sm:w-[100px] sm:h-[100px]'>
                                <Image 
                                        src={'/sofa.png'}
                                        width={105}
                                        height={105}
            ...
            <div className='w-[393px] h-[390px] flex flex-col py-3 gap-[20px] items-center bg-[#F9F1E7] md:self-center md:py-4'>
