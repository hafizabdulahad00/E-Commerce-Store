  ...
  return (
    <section className='w-full h-[505] flex justify-center items-center border-[1px] border-[#D9D9D9] md:h-full md:py-5' >
        <div className='w-[1240px] h-[419px] flex flex-col gap-12 md:w-full md:px-3 md:h-full sm:gap-[8px]'>
            {/* First-row */}
            <div className='flex w-[1133px] h-[312px] justify-center md:w-full md:px-3 sm:flex-col sm:h-full sm:gap-[20px]'>
                {/* Text-box */}
                <div className='w-[530px] h-[312px] flex flex-col gap-[55px] md:w-[30%] sm:w-full sm:gap-[20px] sm:h-full sm:py-3'>
                <h4 className='text-[24px] Poppins text-[#000000] font-bold md:text-[20px]'>Funiro.</h4>
                <p className='text-[16px] Poppins text-[#9F9F9F] md:text-[14px]'>400 University Drive Suite 200 <br /> Coral Gables,<br />
                FL 33134 USA</p>
                </div>
                <div className='w-[710px] md:w-[70%] sm:w-full'>
                    <div className='w-[352px] h-[312px] flex gap-[144px]  md:w-[50%] md:gap[50px] sm:gap-[120px] sm:w-full'>
                        {/* Link-box-1 */}
                        <div className='w-[68px] h-full flex flex-col gap-[55px] md:w-[15%] sm:gap-[20px] sm:h-full sm:w-[30%]'>
                            <h4 className='text-[16px] Poppins text-[#9F9F9F] font-medium md:text-[14px] md:pb-4'>Links</h4>
                            <div className='w-[66px] h-[233px] gap-[46px] flex flex-col'>
                        ...
                        {/* Link-box-2 */}
                        <div className='w-[140px] h-[242px] flex flex-col gap-[55px] md:w-[15%] sm:gap-[20px] sm:h-full sm:w-[30%]'>
                        <h4 className='text-[16px] Poppins text-[#9F9F9F] font-medium md:text-[14px] md:pb-4'>Help</h4>
                        <div className='w-[140px] h-[63px] flex flex-col gap-[46px]'>
                            ...
                            <Link href = "/" className='text-[16px] text-[#000000] Poppins font-medium md:text-[14px]'>Privacy Policies</Link>
                              ...
                              {/* form-box */}
                        <div className='w-[286px] h-[101px] flex flex-col gap-[53px] md:w-[40%] sm:w-[40%]'>
                    <h4 className='text-[16px] Poppins text-[#9F9F9F] font-medium'>Newsletter</h4>
                    <div className='w-full h-6 flex gap-[11px] md:flex-col md:gap-[20px] sm:w-full'>
