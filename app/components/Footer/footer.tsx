  ...
  return (
    <section className='w-full h-[505] flex justify-center items-center border-[1px] border-[#D9D9D9] md:h-full md:py-5' >
        <div className='w-[1240px] h-[419px] flex flex-col gap-12 md:w-full md:px-3 md:h-full sm:gap-[8px]'>
            {/* First-row */}
            <div className='flex w-[1133px] h-[312px] justify-center md:w-full md:px-3 sm:flex-col sm:h-full sm:gap-[20px]  sm:justify-center sm:items-center lg:px-3 lg:w-full'>
                {/* Text-box */}
                ...
                <div className='w-[710px] md:w-[70%] sm:w-full sm:flex sm:justify-center sm:items-center sm:h-full lg:w-full'>
                    ...
                    <div className='w-full h-6 flex gap-[11px] md:flex-col md:gap-[20px] sm:w-full sm:items-center sm:h-full lg:flex-col'>
                        <input type="email" name="email" id="email" placeholder='Enter Your Email Address' className='w-[200px] border-b border-b-[#000000] text-[14px] text-[#9F9F9F] bg-transparent Poppins md:w-[150px] md:text-[12px] sm:w-[80px] lg:w-[170px]'/>
            ...
            {/* Second-row */}
            <div className='w-[1240px] h-[59px] flex flex-col gap-[35px] md:w-full sm:h-full sm:justify-center sm:items-center lg:w-full '>
