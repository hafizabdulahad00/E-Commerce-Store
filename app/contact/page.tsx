      ...
      <div className='w-[1058px] h-[900px] flex gap-[30px] justify-center items-center md:flex-col md:h-full md:gap-[10px] sm:w-full'>
        ...
        <div className='w-[393px] h-[537px] flex flex-col justify-center items-center md:h-full py-[30px]' >
          <div className='w-full h-[179px] flex'>
            {/* icon */}
            <div className='w-[30%] flex justify-end p-5'>
          ...
          <p className='text-[16px] leading-6 text-[#000000] w-[212px]'>236 5th SE Avenue, New York NY10000, United States</p>
          </div>
          </div>
          <div className='w-full h-[179px] flex'>
              {/* icon */}
          ...
          <p className='text-[16px] leading-6 text-[#000000] w-[212px]'>Mobile: +(84) 546-6789
          ...
          <p className='text-[16px] leading-6 text-[#000000] w-[212px]'>Monday-Friday: 9:00 - 22:00
